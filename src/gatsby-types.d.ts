...
type AllFileAndSiteDataQuery = { readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly name: string, readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } }> } };
...
type LatestPostQuery = { readonly allStrapiArticle: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly title: string | null, readonly slug: string | null, readonly publishedAt: string | null, readonly tags: ReadonlyArray<{ readonly name: string | null, readonly color: string | null } | null> | null, readonly cover: { readonly formats: { readonly medium: { readonly url: string | null } | null } | null } | null }> } };

type ProjectImageFilesQueryVariables = Exact<{ [key: string]: never; }>;


type ProjectImageFilesQuery = { readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly name: string, readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } }> } };

type VtuberImageFilesQueryVariables = Exact<{ [key: string]: never; }>;


type VtuberImageFilesQuery = { readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly name: string, readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } }> }, readonly site: { readonly siteMetadata: { readonly author: string | null, readonly title: string | null, readonly description: string | null } | null } | null };
